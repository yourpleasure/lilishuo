...
class BaseWebSocketHandler(WebSocketHandler):
    ...
    #     }
    #     try:
    #         update = await db.User.find_one_and_update({'_id': username}, {'$addToSet': {'friend_list': friend_id}})
    #         if update is None:
    #             result['result'] = False
    #     except Exception as e:
    #         print("Exception: {0}".format(e))
    ...
    #     }
    #     try:
    #         update = await db.User.find_one_and_update({'_id': username}, {'$pull': {'friend_list': friend_id}})
    #         if update is None:
    #             result['result'] = False
    #     except Exception as e:
    #         print("Exception: {0}".format(e))
